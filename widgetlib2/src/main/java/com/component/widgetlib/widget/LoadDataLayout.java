package com.component.widgetlib.widget;
...
import com.component.widgetlib.R;
...
public class LoadDataLayout extends FrameLayout implements View.OnClickListener {
  ...
  public LoadDataLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    builder.setLoadingText(TextUtils.isEmpty(typedArray.getString(R.styleable.LoadDataLayout_loadingText)) ? builder.loadingText
      : typedArray.getString(R.styleable.LoadDataLayout_loadingText));
    ...
    builder.setEmptyText(TextUtils.isEmpty(typedArray.getString(R.styleable.LoadDataLayout_emptyText)) ? builder.emptyText
      : typedArray.getString(R.styleable.LoadDataLayout_emptyText));
    ...
    builder.setErrorText(TextUtils.isEmpty(typedArray.getString(R.styleable.LoadDataLayout_errorText)) ? builder.errorText
      : typedArray.getString(R.styleable.LoadDataLayout_errorText));
    ...
    builder.setNoNetWorkText(TextUtils.isEmpty(typedArray.getString(R.styleable.LoadDataLayout_noNetWorkText)) ? builder.noNetWorkText
      : typedArray.getString(R.styleable.LoadDataLayout_noNetWorkText));
    ...
    builder.setReloadBtnText(TextUtils.isEmpty(typedArray.getString(R.styleable.LoadDataLayout_reloadBtnText)) ? builder.reloadBtnText
      : typedArray.getString(R.styleable.LoadDataLayout_reloadBtnText));
    ...
    builder.setReloadBtnBackgroundResource(
      typedArray.getResourceId(R.styleable.LoadDataLayout_reloadBtnBackgroundResource, builder.reloadBtnBackgroundResource));
    builder.setReloadBtnVisible(typedArray.getBoolean(R.styleable.LoadDataLayout_reloadBtnVisible, builder.reloadBtnVisible));
    builder.setEmptyReloadBtnVisible(typedArray.getBoolean(R.styleable.LoadDataLayout_emptyReloadBtnVisible, builder.emptyReloadBtnVisible));
  ...
  private void build() {
    ...
    if (builder.loadingViewLayoutId != NO_ID) {
      loadingView = LayoutInflater.from(mContext)
                                  .inflate(builder.loadingViewLayoutId, null);
    } else {
      loadingView = LayoutInflater.from(mContext)
                                  .inflate(R.layout.widget_loading_view, null);
    }
    emptyView = LayoutInflater.from(mContext)
                              .inflate(R.layout.widget_empty_view, null);
    errorView = LayoutInflater.from(mContext)
                              .inflate(R.layout.widget_error_view, null);

    noNetworkView = LayoutInflater.from(mContext)
                                  .inflate(R.layout.widget_no_network_view, null);
    ...
    setEmptyReloadBtnVisible(builder.emptyReloadBtnVisible);
  ...
  public void onClick(View view) {
    ...
    int i = view.getId();
    if (i == R.id.empty_layout || i == R.id.empty_reload_btn || i == R.id.error_layout || i == R.id.error_reload_btn || i == R.id.no_network_layout
  ...
  public void setEmptyPadding(int left, int top, int right, int bottom) {
    emptyTv.setPadding(left, top, right, bottom);
  }
  ...
  public LoadDataLayout setEmptyReloadBtnVisible(boolean flag) {
    if (flag) {
  ...
  public LoadDataLayout setNewEmptyView(@NonNull View emptyView) {
    this.emptyLayout.removeAllViews();
    this.emptyLayout.addView(emptyView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    return this;
  }
  ...
  public LoadDataLayout setErrorViewLayoutId(@LayoutRes int layoutId) {
  ...
  public static class Builder {
    ...
    boolean emptyReloadBtnVisible = true;

    int allPageBackgroundColor      = R.color.white;
    int allTipTextColor             = R.color.cmn_black_333333;
    ...
    public Builder setEmptyReloadBtnVisible(boolean flag) {
      this.emptyReloadBtnVisible = flag;
      return this;
    }
